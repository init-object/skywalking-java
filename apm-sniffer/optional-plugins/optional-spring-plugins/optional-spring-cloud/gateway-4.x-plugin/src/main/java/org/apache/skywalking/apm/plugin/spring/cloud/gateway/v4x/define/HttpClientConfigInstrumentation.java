 ...
 * </p>
 */
public class HttpClientConfigInstrumentation extends AbstractGatewayV4EnhancePluginDefine {

    private static final String INTERCEPT_CLASS_HTTP_CLIENT_FINALIZER = "reactor.netty.http.client.HttpClientConfig";
    private static final String CLIENT_FINALIZER_CONSTRUCTOR_INTERCEPTOR = "org.apache.skywalking.apm.plugin.spring.cloud.gateway.v4x.HttpClientConfigConstructorInterceptor";
     @Override
        ...
        return new ConstructorInterceptPoint[]{
                new ConstructorInterceptPoint() {
                    ...
                    public ElementMatcher<MethodDescription> getConstructorMatcher() {
                        return takesArgumentWithType(0, INTERCEPT_CLASS_HTTP_CLIENT_FINALIZER);
                    }
